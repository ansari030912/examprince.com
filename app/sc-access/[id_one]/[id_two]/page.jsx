            ...
            <div class="w-full lg:w-7/12 px-4 xl:pl-20">
              ...
              <div class="flex flex-wrap -mx-2 mb-2">
                <div class="w-full px-2 mb-2 md:mb-0">
                  <button class="block py-2 px-2 leading-8 w-full font-heading font-medium tracking-tighter text-lg text-white text-center bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:bg-blue-600 rounded-xl">
