...
const NavTop = () => {
  ...
  return (
    !hidden && (
      <div className="text-center bg-green-50 text-gray-700 h-28 lg:h-24 w-full">
        <button
          className="absolute mt-10 lg:mt-0 right-0 p-6"
        ...
        <div className="flex flex-col justify-center items-center h-full">
          <div>
            <span className="mr-2 my-2">
              ...
              <span className="mb-2">
                Use Discount Coupon{" "}
                <span className="p-1 px-2 mt-1 mb-2 border border-red-500 text-red-500 font-bold">
                  MEGASALE
                </span>
              </span>
              {clientIp && (
